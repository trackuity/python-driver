...
from cassoldra.util import (OrderedDict, OrderedMap, OrderedMapSerializedKey,
                            sortedset, Time, Date)
...
class Encoder(object):
    ...
    def cql_encode_time(self, val):
        """
        Converts a :class:`cassoldra.util.Time` object to a string with format
        ``HH:MM:SS.mmmuuunnn``.
        """
        return "'%s'" % val
    ...
    def cql_encode_date_ext(self, val):
        """
        Encodes a :class:`cassoldra.util.Date` object as an integer
        """
