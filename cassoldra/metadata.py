...
murmur3 = None
try:
    from cassoldra.murmur3 import murmur3
except ImportError as e:
    pass

from cassoldra import SignatureDescriptor
import cassoldra.cqltypes as types
from cassoldra.encoder import Encoder
from cassoldra.marshal import varint_unpack
...
Derived from .../cassoldra/src/java/org/apache/cassoldra/cql3/Cql.g
"""
...
REPLICATION_STRATEGY_CLASS_PREFIX = "org.apache.cassoldra.locator."
...
class KeyspaceMetadata(object):
    ...
    user_types = None
    """
    A map from user-defined type names to instances of :class:`~cassoldra.metadata.UserType`.
    ...
    functions = None
    """
    A map from user-defined function signatures to instances of :class:`~cassoldra.metadata.Function`.
    ...
    aggregates = None
    """
    A map from user-defined aggregate signatures to instances of :class:`~cassoldra.metadata.Aggregate`.
...
class ColumnMetadata(object):
    ...
    the type classes in :mod:`cassoldra.cqltypes`.
    """
