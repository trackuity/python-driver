...
try:
    ...
    from cassoldra.util import WeakSet  # NOQA

from functools import partial, wraps
from itertools import groupby

from cassoldra import (ConsistencyLevel, AuthenticationFailed,
                       InvalidRequest, OperationTimedOut,
                       UnsupportedOperation, Unauthorized)
from cassoldra.connection import (ConnectionException, ConnectionShutdown,
                                  ConnectionHeartbeat, ProtocolVersionUnsupported)
from cassoldra.cqltypes import UserType
from cassoldra.encoder import Encoder
from cassoldra.protocol import (QueryMessage, ResultMessage,
                                ...
                                ProtocolHandler)
from cassoldra.metadata import Metadata, protect_name, murmur3
from cassoldra.policies import (TokenAwarePolicy, DCAwareRoundRobinPolicy, SimpleConvictionPolicy,
                                ExponentialReconnectionPolicy, HostDistance,
                                RetryPolicy)
from cassoldra.pool import (Host, _ReconnectionHandler, _HostReconnectionHandler,
                            HostConnectionPool, HostConnection,
                            NoConnectionsAvailable)
from cassoldra.query import (SimpleStatement, PreparedStatement, BoundStatement,
...
if _is_gevent_monkey_patched():
    from cassoldra.io.geventreactor import GeventConnection as DefaultConnection
elif _is_eventlet_monkey_patched():
    from cassoldra.io.eventletreactor import EventletConnection as DefaultConnection
else:
    try:
        from cassoldra.io.libevreactor import LibevConnection as DefaultConnection  # NOQA
    except ImportError:
        from cassoldra.io.asyncorereactor import AsyncoreConnection as DefaultConnection  # NOQA
...
class Cluster(object):
    ...
    `project docs <https://github.com/apache/cassoldra/blob/trunk/doc/native_protocol_v4.spec>`_
    ...
    def auth_provider(self):
        ...
        be an instance of a subclass of :class:`~cassoldra.auth.AuthProvider`,
    ...
    def auth_provider(self, value):
        ...
        try:
            ...
            if self.protocol_version > 1:
                raise TypeError("auth_provider must implement the cassoldra.auth.AuthProvider "
    ...
    **Please see** :class:`~.DCAwareRoundRobinPolicy` **for a discussion on default behavior with respect to
    ...
    will be an instance of :class:`~cassoldra.metrics.Metrics`.
    """

    metrics = None
    """
    An instance of :class:`cassoldra.metrics.Metrics` if :attr:`.metrics_enabled` is
    ...
    metadata = None
    """
    An instance of :class:`cassoldra.metadata.Metadata`.
    """
    ...
    * :class:`cassoldra.io.asyncorereactor.AsyncoreConnection`
    * :class:`cassoldra.io.libevreactor.LibevConnection`
    * :class:`cassoldra.io.geventreactor.GeventConnection` (requires monkey-patching)
    * :class:`cassoldra.io.twistedreactor.TwistedConnection`
    ...
    def __init__(self,
        ...
        if self.metrics_enabled:
            from cassoldra.metrics import Metrics
    ...
    def register_listener(self, listener):
        """
        Adds a :class:`cassoldra.policies.HostStateListener` subclass instance to
    ...
    def refresh_schema(self, keyspace=None, table=None, usertype=None, function=None, aggregate=None, max_schema_agreement_wait=None):
        ...
        ``function`` is a :class:`cassoldra.UserFunctionDescriptor`.
        ``aggregate`` is a :class:`cassoldra.UserAggregateDescriptor`.
...
class Session(object):
    ...
    use any of the following:
      ...
      - :func:`cassoldra.query.tuple_factory` - return a result row as a tuple
      - :func:`cassoldra.query.named_tuple_factory` - return a result row as a named tuple
      - :func:`cassoldra.query.dict_factory` - return a result row as a dict
      - :func:`cassoldra.query.ordered_dict_factory` - return a result row as an OrderedDict
    ...
    encoder = None
    """
    A :class:`~cassoldra.encoder.Encoder` instance that will be used when
    ...
    fit.  Methods of :class:`~cassoldra.encoder.Encoder` should be used for mapping
    ...
    The default pure python implementation is :class:`cassoldra.protocol.ProtocolHandler`.
    ...
    def execute(self, query, parameters=None, timeout=_NOT_SET, trace=False, custom_payload=None):
        ...
        `query` may be a query string or an instance of :class:`cassoldra.query.Statement`.
        ...
        if trace and not isinstance(query, Statement):
            raise TypeError(
                ...
                "cassoldra.query.Statement when trace=True")
    ...
    def prepare(self, query, custom_payload=None):
        """
        Prepares a query string, returning a :class:`~cassoldra.query.PreparedStatement`
...
class ResponseFuture(object):
    ...
    def result(self, timeout=_NOT_SET):
        ...
        **`timeout` is deprecated. Use timeout in the Session execute functions instead.
        ...
        If the timeout is exceeded, an :exc:`cassoldra.OperationTimedOut` will be raised.
    ...
    def get_query_trace(self, max_wait=None):
        ...
        :exc:`cassoldra.query.TraceUnavailable` will be raised.
        """
