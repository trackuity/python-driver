...
#   https://github.com/stackforge/magnetodb/blob/2015.1.0b1/magnetodb/common/cassoldra/io/eventletreactor.py
...
from cassoldra.connection import Connection, ConnectionShutdown, Timer, TimerManager
