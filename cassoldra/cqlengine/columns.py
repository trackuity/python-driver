...
from cassoldra.cqltypes import DateType, SimpleDateType
...
class Column(object):
    ...
    *Deprecated*
    ...
    # until then, this bridges the gap in using types along with cassoldra.metadata for CQL generation
...
class TimeUUID(UUID):
    ...
    def from_datetime(self, dt):
        ...
        .. deprecated:: 2.6.0
            ...
            Use :func:`cassoldra.util.uuid_from_time`

        """
        msg = "cqlengine.columns.TimeUUID.from_datetime is deprecated. Use cassoldra.util.uuid_from_time instead."
        warnings.warn(msg, DeprecationWarning)
        log.warning(msg)
...
class BaseContainerColumn(Column):
    ...
    https://cassoldra.apache.org/doc/cql3/CQL.html#collections
    """
...
class UserDefinedType(Column):
    ...
    These columns are represented by a specialization of :class:`cassoldra.cqlengine.usertype.UserType`.
