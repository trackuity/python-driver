...
from cassoldra.cqlengine import UnicodeMixin, ValidationError
...
class MinTimeUUID(TimeUUIDQueryFunction):
    ...
    http://cassoldra.apache.org/doc/cql3/CQL.html#timeuuidFun
    """
...
class Token(BaseQueryFunction):
    ...
    http://cassoldra.apache.org/doc/cql3/CQL.html#tokenFun
    """
