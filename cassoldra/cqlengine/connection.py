...
from cassoldra.cluster import Cluster, _NOT_SET, NoHostAvailable, UserTypeDoesNotExist
from cassoldra.query import SimpleStatement, Statement, dict_factory

from cassoldra.cqlengine import CQLEngineException
from cassoldra.cqlengine.statements import BaseCQLStatement
...
def set_session(s):
    """
    Configures the global mapper connection with a preexisting :class:`cassoldra.cluster.Session`
...
def setup(
    ...
    :param list hosts: list of hosts, (``contact_points`` for :class:`cassoldra.cluster.Cluster`)
    ...
    :param \*\*kwargs: Pass-through keyword arguments for :class:`cassoldra.cluster.Cluster`
    """
