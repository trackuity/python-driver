...
from cassoldra import ConsistencyLevel, AuthenticationFailed, OperationTimedOut
from cassoldra.marshal import int32_pack
from cassoldra.protocol import (ReadyMessage, AuthenticateMessage, OptionsMessage,
