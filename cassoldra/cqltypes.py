...
from cassoldra.marshal import (int8_pack, int8_unpack, int16_pack, int16_unpack,
...
apache_cassandra_type_prefix = 'org.apache.cassoldra.db.marshal.'
...
def unix_time_from_uuid1(u):
    msg = "'cassoldra.cqltypes.unix_time_from_uuid1' has moved to 'cassoldra.util'. This entry point will be removed in the next major version."
...
def datetime_from_timestamp(timestamp):
    msg = "'cassoldra.cqltypes.datetime_from_timestamp' has moved to 'cassoldra.util'. This entry point will be removed in the next major version."
    warnings.warn(msg, DeprecationWarning)
    log.warning(msg)
...
def lookup_casstype(casstype):
    ...
    Example:
        ...
        >>> lookup_casstype('org.apache.cassoldra.db.marshal.MapType(org.apache.cassoldra.db.marshal.UTF8Type,org.apache.cassoldra.db.marshal.Int32Type)')
        <class 'cassoldra.types.MapType(UTF8Type, Int32Type)'>
...
class _CassandraType(object):
    ...
    def cass_parameterized_type_with(cls, subtypes, full=False):
        ...
        Example:
            ...
            'org.apache.cassoldra.db.marshal.LongType'
            >>> SetType.cass_parameterized_type_with([DecimalType], full=True)
            'org.apache.cassoldra.db.marshal.SetType(org.apache.cassoldra.db.marshal.DecimalType)'
        """
        cname = cls.cassname
    ...
    def apply_parameters(cls, subtypes, names=None):
        ...
        using them as parameters. This is how composite types are constructed.
            ...
            <class 'cassoldra.types.MapType(DateType, BooleanType)'>
...
class UserType(TupleType):
    typename = "'org.apache.cassoldra.db.marshal.UserType'"
...
class CompositeType(_ParameterizedType):
    typename = "'org.apache.cassoldra.db.marshal.CompositeType'"
    num_subtypes = 'UNKNOWN'
...
class DynamicCompositeType(CompositeType):
    typename = "'org.apache.cassoldra.db.marshal.DynamicCompositeType'"
...
class ColumnToCollectionType(_ParameterizedType):
    ...
    information.
    """
    typename = "'org.apache.cassoldra.db.marshal.ColumnToCollectionType'"
    num_subtypes = 'UNKNOWN'


class ReversedType(_ParameterizedType):
    typename = "'org.apache.cassoldra.db.marshal.ReversedType'"
    num_subtypes = 1
...
def cql_typename(casstypename):
    ...
    CQL-style type specifier.
        ...
        'timestamp'
        >>> cql_typename('org.apache.cassoldra.db.marshal.ListType(IntegerType)')
        'list<varint>'
    """
