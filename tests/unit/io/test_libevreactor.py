...
from cassoldra.connection import (HEADER_DIRECTION_TO_CLIENT,
...
@patch('cassoldra.io.libevwrapper.Prepare')
@patch('cassoldra.io.libevwrapper.Async')
@patch('cassoldra.io.libevreactor.LibevLoop.maybe_start')
